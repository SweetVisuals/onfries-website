              ...
              <div className="flex justify-between items-start mb-2">
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <p className="font-bold text-lg text-card-foreground">{orderItem.item.name}</p>
                    <span className="text-sm text-muted-foreground">x{orderItem.quantity}</span>
                  </div>
                  {orderItem.item.description && (
                    <p className="text-sm text-muted-foreground mt-1">{orderItem.item.description}</p>
                  )}
                </div>
                <p className="font-semibold text-lg text-card-foreground">£{(orderItem.item.price * orderItem.quantity).toFixed(2)}</p>
              </div>
